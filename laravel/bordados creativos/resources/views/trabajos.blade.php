            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/camisas.jpeg" alt="#" />
                    </div>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/chamarra.jpeg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>chamarras</h3>
                        <h4><span class="theme_color"></span></h4>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/83691422_1243539832509261_6328477896537014272_o.jpg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>muñecos</h3>
                        <h4><span class="theme_color"></span></h4>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/gorras.jpeg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>gorras</h3>
                        <h4><span class="theme_color"></span></h4>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/chaleco.jpeg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>chalecos</h3>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/89657019_1275968659266378_5471895185300389888_n.jpg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>playeras</h3>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/imss_bordado.jpg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>uniformes</h3>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/no_drama_llama.jpg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>Colchones</h3>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/bordado4.jpeg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>toallas</h3>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="imagenes/inventario/sueter_navidad.jpeg" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>Y muchas mas cosas...</h3>
                        <h4><span class="theme_color">$</span>50</h4>
                    </div>
                </div>
